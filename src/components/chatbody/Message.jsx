...
const Message = ({ message, isCurrentUser }) => {
  ...
  const formatTimestamp = (timestamp) => {
    if (
      ...
      return ""; // Return an empty string if timestamp is not valid
    }
  ...
  return (
    <div ref={ref} className={`flex ${isCurrentUser ? "" : "justify-end"}`}>
      {message && ( // Check if there is a message before rendering the container
        <div className="flex flex-col">
          <div
            className={`flex items-center ml-2 mr-2 gap-3 ${
          ...
          >
            ...
            <div>
              ...
              {message.text && ( // Check if there is text message before rendering
                <div
                  className={`bg-white text-slate-900 p-1 pl-2 pr-2 rounded-xl ${
          ...
          <div
            className={`flex text-xs text-slate-600 ${
              isCurrentUser ? "ml-3 justify-start" : "justify-end mr-3"
            }`}
          >
